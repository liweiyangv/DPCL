...
class Synthia(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        rgb_mean_std = ([0.5, 0.5, 0.5], [0.5, 0.5, 0.5])
        ...
        return img_gt, mask, img_name, mask_aux
...
class SynthiaUniform(data.Dataset):
    ...
    def __getitem__(self, index):
       ...
       # if self.transform is not None:
        ...
        train_input_transform += [transforms.ColorJitter(0.2, 0.2, 0.2, 0.1)]
        train_input_transform += [transforms.RandomApply([RandomGaussianNoise()], p=0.5)]
