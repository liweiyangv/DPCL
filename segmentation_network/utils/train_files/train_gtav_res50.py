...
def main():
    ...
    if args.use_warmup:
        ...
        seg_checkpoint = torch.load(
            '/public/home/yangliwei/DG_project/snapshots/disturb_recon_ori_with_alter_mean_var/6_lr_1e_3_7000_warmup/GTA5_only_seg_epoch_9.pth',map_location={'cuda:0':'cuda:1'})
        model_transfer.load_state_dict(torch.load(
            '/public/home/yangliwei/DG_project/snapshots/disturb_recon_ori_with_alter_mean_var/6_lr_1e_3_7000_warmup/GTA5_only_transfer_epoch_9.pth',map_location={'cuda:0':'cuda:1'}))
        net = optimizer.forgiving_state_restore(net, seg_checkpoint)
        optim_old = torch.load(
            '/public/home/yangliwei/DG_project/snapshots/disturb_recon_ori_with_alter_mean_var/6_lr_1e_3_7000_warmup/optim_epoch_9.pth',map_location={'cuda:0':'cuda:1'})
        optim.load_state_dict(optim_old)
        scheduler.load_state_dict(torch.load(
            '/public/home/yangliwei/DG_project/snapshots/disturb_recon_ori_with_alter_mean_var/6_lr_1e_3_7000_warmup/scheduler_epoch_9.pth',map_location={'cuda:0':'cuda:1'}))
        optimizer_transfer.load_state_dict(torch.load(
            '/public/home/yangliwei/DG_project/snapshots/disturb_recon_ori_with_alter_mean_var/6_lr_1e_3_7000_warmup/optimizer_transfer_epoch_9.pth',map_location={'cuda:0':'cuda:1'}))
        epoch = 10
    else:
    ...
    for i, data in enumerate(train_loader):
        ...
        for di, ingredients in enumerate(zip(ori_image,inputs, gts, aux_gts)):
            ...
            if curr_epoch > args.warmup_end_epoch:
                ...
                instance_pic_memory_contrastive_loss = instance_triplet_loss(instance_protoype, prototype_normalize, 0.5)
