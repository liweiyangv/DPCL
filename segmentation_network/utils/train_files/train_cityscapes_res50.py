...
PRETRAINED_AUTOENCODER = '/public/home/yangliwei/DG_project/snapshots/ae/disturb_recon_ori_with_alter_mean_var/ciyscapes/0_2_0_2_0_2_0_1_noise/GTA5_only_transfer_120000.pth'
SNAPSHOT_DIR = '/public/home/yangliwei/DG_project/snapshots/disturb_recon_ori_with_alter_mean_var/total_method_cityscapes_5_1e_3_bs8_50000_12wae_v6_check/'
VISUAL_RESULT = '/public/home/yangliwei/DG_project/result/disturb_recon_ori_with_alter_mean_var/total_method_cityscapes_5_1e_3_bs8_50000_12wae_v6_check/'
PRE_RESULT = '/public/home/yangliwei/DG_project/pre_result/prototype_classifer/total_method_cityscapes_5_1e_3_bs8_50000_12wae_v6_check/'
...
parser.add_argument('--arch', type=str, default='network.deepv3_ori_prototype_dec2.DeepR50V3PlusD',
...
parser.add_argument('--date', type=str, default='2022_8_10_619',
                    help='experiment directory date name')
parser.add_argument('--exp', type=str, default='total_method_cityscapes_5_1e_3_bs8_50000_12wae_v6',
...
def main():
    ...
    if args.use_warmup:
        ...
        seg_checkpoint = torch.load(
            '/public/home/yangliwei/DG_project/snapshots/disturb_recon_ori_with_alter_mean_var/total_method_cityscapes_5_1e_3_bs8_50000_12wae/GTA5_only_seg_epoch_9.pth',map_location='cpu')
        net = optimizer.forgiving_state_restore(net, seg_checkpoint)
        model_transfer.load_state_dict(torch.load(args.pretrained_autoencoder,map_location='cpu'))
        optim_old = torch.load(
            '/public/home/yangliwei/DG_project/snapshots/disturb_recon_ori_with_alter_mean_var/total_method_cityscapes_5_1e_3_bs8_50000_12wae/optim_epoch_9.pth',map_location='cpu')
        optim.load_state_dict(optim_old)
        #optim.param_groups[0]['lr'] = optim_old['param_groups'][0]['lr']
        scheduler.load_state_dict(torch.load(
            '/public/home/yangliwei/DG_project/snapshots/disturb_recon_ori_with_alter_mean_var/total_method_cityscapes_5_1e_3_bs8_50000_12wae/scheduler_epoch_9.pth',map_location='cpu'))
        epoch = 10
    else:
...
def train(train_loader, net, model_transfer, optim, optimizer_transfer, curr_epoch, writer,scheduler,class_prototype, cal_update_num,weighted_matrix,max_iter,extra_val_loaders,criterion_val):
    ...
    for i, data in enumerate(train_loader):
        ...
        if (curr_iter+1) % 250 == 0:
            #for dataset, val_loader in extra_val_loaders.items():
              #  print("Extra validating... This won't save pth file")
                #validate(val_loader, dataset, net, criterion_val, optim, scheduler, int(curr_iter+1), writer, i, model_transfer,
                  #       optimizer_transfer, class_prototype, save_pth=False)
