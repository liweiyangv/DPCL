...
SNAPSHOT_DIR = '/public/home/yangliwei/DG_project/snapshots/disturb_recon_ori_with_alter_mean_var/total_method_cityscapes_v6_shufflenet/'
VISUAL_RESULT = '/public/home/yangliwei/DG_project/result/disturb_recon_ori_with_alter_mean_var/total_method_cityscapes_v6_shufflenet/'
PRE_RESULT = '/public/home/yangliwei/DG_project/pre_result/prototype_classifer/total_method_cityscapes_v6_shufflenet/'
...
parser.add_argument('--arch', type=str, default='network.deepv3_ori_prototype_dec2.DeepShuffleNetV3PlusD',
...
parser.add_argument('--date', type=str, default='2022_8_14_619',
                    help='experiment directory date name')
parser.add_argument('--exp', type=str, default='total_method_cityscapes_v6_shufflenet',
...
parser.add_argument("--gpu", type=int, default=1, help="choose gpu device.")
